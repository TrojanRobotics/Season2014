...
public class Config {
    ...
    static final int[] COMPRESSOR = {2, 7};
...
//	Motors: Main Bot
    ...
    static final int GEAR_SHIFT_SOLENOID = 1;
...
//	Motors: Test Bot
    ...
    static final int RETRIEVAL_ANGLE_MOTOR = 6;
    static final int BELT_MOTOR = 7;
    ...
    static final int WINCH_RELEASE_SOLENOID = 2;
